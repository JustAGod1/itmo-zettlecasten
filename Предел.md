...
#### Последовательность
$L \stackrel{def}{=}\text{lim}_{n\rightarrow+\infty}f_n\Leftrightarrow \forall\epsilon>0 \exists n_0 \in N | \forall n > n_0 |f_n-L| < \epsilon$
$n_0=n_0(\epsilon)$

$\forall \epsilon > 0 \exists n_0 \in N \forall n \in \stackrel{o}{U}_{n_0}(+\infty) x_n \in U_{\epsilon}(L)$

#### Функция
$L \stackrel{def}{=}\text{lim}_{n\rightarrow a}f(x)\Leftrightarrow \forall\epsilon>0 \exists \delta > 0 | \forall x \in \stackrel{o}{U_{\delta}}(a), f(x)\in U_{\epsilon}(L)$
